...
fn: function (){
var self=this;
return unescape("G%F6ran%20Krampe");
return self;},
args: [],
source: unescape('author%0A%09%5E%27G%F6ran%20Krampe%27'),
messageSends: [],
referencedClasses: []
}),
...
fn: function (){
var self=this;
return unescape("SweSUG%202012%2C%20Stockholm");
return self;},
args: [],
source: unescape('description%0A%09%5E%27SweSUG%202012%2C%20Stockholm%27'),
messageSends: [],
referencedClasses: []
}),
smalltalk.SweSUG2012Presentation);
...
fn: function (){
var self=this;
return unescape("goran@krampe.se");
return self;},
args: [],
source: unescape('email%0A%09%5E%27goran@krampe.se%27'),
messageSends: [],
referencedClasses: []
}),
smalltalk.SweSUG2012Presentation);
...
fn: function (){
var self=this;
return (function($rec){smalltalk.send($rec, "_add_", [(smalltalk.SweSUGIntroSlide || SweSUGIntroSlide)]);smalltalk.send($rec, "_add_", [(smalltalk.SweSUGAboutSlide || SweSUGAboutSlide)]);smalltalk.send($rec, "_add_", [(smalltalk.SweSUGWhatIsAmberSlide || SweSUGWhatIsAmberSlide)]);smalltalk.send($rec, "_add_", [(smalltalk.SweSUGAmberFeaturesSlide || SweSUGAmberFeaturesSlide)]);smalltalk.send($rec, "_add_", [(smalltalk.SweSUGWorkspaceSlide || SweSUGWorkspaceSlide)]);smalltalk.send($rec, "_add_", [(smalltalk.IDESlide || IDESlide)]);smalltalk.send($rec, "_add_", [(smalltalk.CountersSlide || CountersSlide)]);smalltalk.send($rec, "_add_", [(smalltalk.JtalkAndJavascriptSlide || JtalkAndJavascriptSlide)]);smalltalk.send($rec, "_add_", [(smalltalk.JtalkAndJavascriptSlide2 || JtalkAndJavascriptSlide2)]);smalltalk.send($rec, "_add_", [(smalltalk.JtalkAndJavascriptSlide3 || JtalkAndJavascriptSlide3)]);smalltalk.send($rec, "_add_", [(smalltalk.JtalkAndJavascriptSlide4 || JtalkAndJavascriptSlide4)]);smalltalk.send($rec, "_add_", [(smalltalk.JtalkAndCLI || JtalkAndCLI)]);smalltalk.send($rec, "_add_", [(smalltalk.JtalkAndNode || JtalkAndNode)]);smalltalk.send($rec, "_add_", [(smalltalk.JtalkAndNode2 || JtalkAndNode2)]);smalltalk.send($rec, "_add_", [(smalltalk.JtalkAndNode3 || JtalkAndNode3)]);smalltalk.send($rec, "_add_", [(smalltalk.JtalkAndWebOS || JtalkAndWebOS)]);smalltalk.send($rec, "_add_", [(smalltalk.JtalkAndEnyo || JtalkAndEnyo)]);smalltalk.send($rec, "_add_", [(smalltalk.ContributionsSlide || ContributionsSlide)]);return smalltalk.send($rec, "_yourself", []);})(smalltalk.send((smalltalk.Array || Array), "_new", []));
return self;},
args: [],
source: unescape('slideClasses%0A%09%5EArray%20new%0A%09%09add%3A%20SweSUGIntroSlide%3B%0A%09%09add%3A%20SweSUGAboutSlide%3B%0A%09%09add%3A%20SweSUGWhatIsAmberSlide%3B%0A%09%09add%3A%20SweSUGAmberFeaturesSlide%3B%0A%09%09add%3A%20SweSUGWorkspaceSlide%3B%0A%09%09add%3A%20IDESlide%3B%0A%09%09add%3A%20CountersSlide%3B%0A%09%09add%3A%20JtalkAndJavascriptSlide%3B%0A%09%09add%3A%20JtalkAndJavascriptSlide2%3B%0A%09%09add%3A%20JtalkAndJavascriptSlide3%3B%0A%09%09add%3A%20JtalkAndJavascriptSlide4%3B%0A%09%09add%3A%20JtalkAndCLI%3B%0A%09%09add%3A%20JtalkAndNode%3B%0A%09%09add%3A%20JtalkAndNode2%3B%0A%09%09add%3A%20JtalkAndNode3%3B%0A%09%09add%3A%20JtalkAndWebOS%3B%0A%09%09add%3A%20JtalkAndEnyo%3B%0A%09%09add%3A%20ContributionsSlide%3B%0A%09%09yourself'),
messageSends: ["add:", "yourself", "new"],
referencedClasses: ["SweSUGIntroSlide", "SweSUGAboutSlide", "SweSUGWhatIsAmberSlide", "SweSUGAmberFeaturesSlide", "SweSUGWorkspaceSlide", "IDESlide", "CountersSlide", "JtalkAndJavascriptSlide", "JtalkAndJavascriptSlide2", "JtalkAndJavascriptSlide3", "JtalkAndJavascriptSlide4", "JtalkAndCLI", "JtalkAndNode", "JtalkAndNode2", "JtalkAndNode3", "JtalkAndWebOS", "JtalkAndEnyo", "ContributionsSlide", "Array"]
}),
smalltalk.SweSUG2012Presentation);
...
fn: function (){
var self=this;
return unescape("http%3A//www.amber-lang.net");
return self;},
args: [],
source: unescape('url%0A%09%5E%27http%3A//www.amber-lang.net%27'),
messageSends: [],
referencedClasses: []
}),
smalltalk.SweSUG2012Presentation);
...
fn: function (){
var self=this;
return unescape("Amber%20rocks%21");
return self;},
args: [],
source: unescape('title%0A%09%5E%27Amber%20rocks%21%27'),
messageSends: [],
referencedClasses: []
}),
smalltalk.SweSUG2012Presentation.klass);
...
fn: function (html){
var self=this;
(function($rec){smalltalk.send($rec, "_class_", ["section center"]);return smalltalk.send($rec, "_with_", [(function(){smalltalk.send(smalltalk.send(html, "_h1", []), "_with_", ["About this presentation"]);smalltalk.send(smalltalk.send(html, "_p", []), "_with_", ["This presentation is entirely written in Amber. Lots of stuff was heavily copied from the two earlier presentations from ESUG and FOSDEM."]);smalltalk.send(smalltalk.send(html, "_p", []), "_with_", [(function(){smalltalk.send(html, "_with_", ["Press "]);smalltalk.send(smalltalk.send(html, "_code", []), "_with_", [unescape("%u2190")]);smalltalk.send(html, "_with_", [" to move backward and "]);smalltalk.send(smalltalk.send(html, "_code", []), "_with_", [unescape("%20%u2192")]);return smalltalk.send(html, "_with_", [" to move forward."]);})]);return smalltalk.send(smalltalk.send(html, "_p", []), "_with_", [(function(){smalltalk.send(html, "_with_", ["Open a "]);(function($rec){smalltalk.send($rec, "_with_", ["browser"]);return smalltalk.send($rec, "_onClick_", [(function(){return smalltalk.send((smalltalk.Browser || Browser), "_openOn_", [(smalltalk.Presentation || Presentation)]);})]);})(smalltalk.send(html, "_button", []));return smalltalk.send(html, "_with_", [" to edit the source code."]);})]);})]);})(smalltalk.send(html, "_div", []));
return self;},
args: ["html"],
source: unescape('renderSlideOn%3A%20html%0A%09html%20div%20class%3A%20%27section%20center%27%3B%20with%3A%20%5B%0A%09%09html%20h1%20with%3A%20%27About%20this%20presentation%27.%0A%09%09html%20p%20with%3A%20%27This%20presentation%20is%20entirely%20written%20in%20Amber.%20Lots%20of%20stuff%20was%20heavily%20copied%20from%20the%20two%20earlier%20presentations%20from%20ESUG%20and%20FOSDEM.%27.%0A%09%09html%20p%20with%3A%20%5B%0A%09%09%09html%20with%3A%20%27Press%20%27.%0A%09%09%09html%20code%20with%3A%20%27%u2190%27.%0A%09%09%09html%20with%3A%20%27%20to%20move%20backward%20and%20%27.%0A%09%09%09html%20code%20with%3A%20%27%20%u2192%27.%0A%09%09%09html%20with%3A%20%27%20to%20move%20forward.%27%5D.%0A%09%09html%20p%20with%3A%20%5B%0A%09%09%09html%20with%3A%20%27Open%20a%20%27.%0A%09%09%09html%20button%20%0A%09%09%09%09with%3A%20%27browser%27%3B%0A%09%09%09%09onClick%3A%20%5BBrowser%20openOn%3A%20Presentation%5D.%0A%09%09%09html%20with%3A%20%27%20to%20edit%20the%20source%20code.%27%5D%5D'),
messageSends: ["class:", "with:", "h1", "p", "code", "onClick:", "openOn:", "button", "div"],
referencedClasses: ["Browser", "Presentation"]
}),
smalltalk.SweSUGAboutSlide);
...
smalltalk.send(smalltalk.send(html, "_ul", []), "_with_", [(function(){smalltalk.send(smalltalk.send(html, "_li", []), "_with_", [unescape("Amber%20is%20%28mostly%29%20written%20in%20itself%2C%20including%20the%20compiler")]);smalltalk.send(smalltalk.send(html, "_li", []), "_with_", [unescape("Full%20Smalltalk%20object%20system%2C%20including%20classes%20%26%20metaclasses%2C%20etc")]);smalltalk.send(smalltalk.send(html, "_li", []), "_with_", [unescape("Core%20libraries%20%28streams%2C%20collections%2C%20RegExp%2C%20etc%29")]);smalltalk.send(smalltalk.send(html, "_li", []), "_with_", [unescape("Web%20related%20libraries%3A%20HTML%20Canvas%2C%20DOM%20manipulation")]);smalltalk.send(smalltalk.send(html, "_li", []), "_with_", [unescape("Very%20good%20javascript%20integration%2C%20both%20ways")]);smalltalk.send(smalltalk.send(html, "_li", []), "_with_", [unescape("Full%20featured%20IDE%21")]);return smalltalk.send(smalltalk.send(html, "_li", []), "_with_", [(function(){smalltalk.send(html, "_with_", [unescape("Advanced%20features%2C%20including%20")]);smalltalk.send(smalltalk.send(html, "_code", []), "_with_", [unescape("%23doesNotUnderstand%3A")]);smalltalk.send(html, "_with_", [" support and "]);return smalltalk.send(smalltalk.send(html, "_code", []), "_with_", ["thisContext"]);})]);})]);
return self;},
args: ["html"],
source: unescape('renderSlideOn%3A%20html%0A%09html%20h1%20with%3A%20%27Amber%20features%27.%0A%09html%20ul%20with%3A%20%5B%0A%09%09html%20li%20with%3A%20%27Amber%20is%20%28mostly%29%20written%20in%20itself%2C%20including%20the%20compiler%27.%0A%09%09html%20li%20with%3A%20%27Full%20Smalltalk%20object%20system%2C%20including%20classes%20%26%20metaclasses%2C%20etc%27.%0A%09%09html%20li%20with%3A%20%27Core%20libraries%20%28streams%2C%20collections%2C%20RegExp%2C%20etc%29%27.%0A%09%09html%20li%20with%3A%20%27Web%20related%20libraries%3A%20HTML%20Canvas%2C%20DOM%20manipulation%27.%0A%09%09html%20li%20with%3A%20%27Very%20good%20javascript%20integration%2C%20both%20ways%27.%0A%09%09html%20li%20with%3A%20%27Full%20featured%20IDE%21%27.%0A%09%09html%20li%20with%3A%20%5B%0A%09%09%09html%20with%3A%27Advanced%20features%2C%20including%20%27.%0A%09%09%09html%20code%20with%3A%20%27%23doesNotUnderstand%3A%27.%0A%09%09%09html%20with%3A%20%27%20support%20and%20%27.%0A%09%09%09html%20code%20with%3A%20%27thisContext%27%5D%5D'),
messageSends: ["with:", "h1", "ul", "li", "code"],
referencedClasses: []
}),
smalltalk.SweSUGAmberFeaturesSlide);
...
return self;},
args: [],
source: unescape('id%0A%09%5E%27WhatIsAmber%27'),
messageSends: [],
referencedClasses: []
}),
...
fn: function (html){
var self=this;
(function($rec){smalltalk.send($rec, "_class_", ["section center"]);return smalltalk.send($rec, "_with_", [(function(){smalltalk.send(html, "_img_", [unescape("esug2011/images/balloon.jpg")]);smalltalk.send(smalltalk.send(html, "_h1", []), "_with_", ["Amber in a nutshell"]);smalltalk.send(smalltalk.send(html, "_h2", []), "_with_", ["Amber is a true Smalltalk"]);smalltalk.send(smalltalk.send(html, "_h2", []), "_with_", [unescape("It%20compiles%20to%20and%20runs%20on/in%20JavaScript")]);smalltalk.send(smalltalk.send(html, "_h2", []), "_with_", ["MIT license"]);return (function($rec){smalltalk.send($rec, "_class_", ["fancy"]);return smalltalk.send($rec, "_with_", [unescape("Amber%20is%20way%20cool%21")]);})(smalltalk.send(html, "_h2", []));})]);})(smalltalk.send(html, "_div", []));
return self;},
args: ["html"],
source: unescape('renderSlideOn%3A%20html%0A%09html%20div%20class%3A%20%27section%20center%27%3B%20with%3A%20%5B%0A%09%09html%20img%3A%20%27esug2011/images/balloon.jpg%27.%0A%09%09html%20h1%20with%3A%20%27Amber%20in%20a%20nutshell%27.%0A%09%09html%20h2%20with%3A%20%27Amber%20is%20a%20true%20Smalltalk%27.%0A%09%09html%20h2%20with%3A%20%27It%20compiles%20to%20and%20runs%20on/in%20JavaScript%27.%0A%09%09html%20h2%20with%3A%20%27MIT%20license%27.%0A%09%09html%20h2%20class%3A%20%27fancy%27%3B%20with%3A%20%27Amber%20is%20way%20cool%21%27%5D'),
messageSends: ["class:", "with:", "img:", "h1", "h2", "div"],
referencedClasses: []
}),
smalltalk.SweSUGWhatIsAmberSlide);
...
(function($rec){smalltalk.send($rec, "_class_", ["section center"]);return smalltalk.send($rec, "_with_", [(function(){smalltalk.send(smalltalk.send(html, "_h1", []), "_with_", [unescape("Give%20Amber%20a%20try%21")]);smalltalk.send(workspace, "_renderOn_", [html]);return smalltalk.send(smalltalk.send(html, "_div", []), "_with_", [(function(){(function($rec){smalltalk.send($rec, "_with_", ["DoIt"]);return smalltalk.send($rec, "_onClick_", [(function(){return smalltalk.send(workspace, "_doIt", []);})]);})(smalltalk.send(html, "_button", []));(function($rec){smalltalk.send($rec, "_with_", ["PrintIt"]);return smalltalk.send($rec, "_onClick_", [(function(){return smalltalk.send(workspace, "_printIt", []);})]);})(smalltalk.send(html, "_button", []));return (function($rec){smalltalk.send($rec, "_with_", ["InspectIt"]);return smalltalk.send($rec, "_onClick_", [(function(){return smalltalk.send(workspace, "_inspectIt", []);})]);})(smalltalk.send(html, "_button", []));})]);})]);})(smalltalk.send(html, "_div", []));
return self;},
args: ["html"],
source: unescape('renderSlideOn%3A%20html%0A%09%7C%20workspace%20%7C%0A%09workspace%20%3A%3D%20SourceArea%20new.%0A%09html%20div%20class%3A%20%27section%20center%27%3B%20with%3A%20%5B%0A%09%09html%20h1%20with%3A%20%27Give%20Amber%20a%20try%21%27.%0A%09%09workspace%20renderOn%3A%20html.%0A%09%09html%20div%20with%3A%20%5B%0A%09%09%09html%20button%0A%09%09%09%09with%3A%20%27DoIt%27%3B%0A%09%09%09%09onClick%3A%20%5Bworkspace%20doIt%5D.%0A%09%09%09html%20button%0A%09%09%09%09with%3A%20%27PrintIt%27%3B%0A%09%09%09%09onClick%3A%20%5Bworkspace%20printIt%5D.%0A%09%09%09html%20button%0A%09%09%09%09with%3A%20%27InspectIt%27%3B%0A%09%09%09%09onClick%3A%20%5Bworkspace%20inspectIt%5D%5D%5D'),
