...
$1=_st((smalltalk.PieChartExample || PieChartExample))._new();
_st($1)._chartId_("row3");
$2=_st($1)._drawChart();
$3=smalltalk.ChartApp.fn.prototype._begin.apply(_st(self), []);
return $3;
}, function($ctx1) {$ctx1.fill(self,"begin",{}, smalltalk.IndexChartApp)})},
args: [],
source: "begin\x0a\x09\x22Start the executiong of the ExampleChartApp by connecting each button/graphic pair\x22\x0a    PieChartExample new chartId:'row3';drawChart.\x0a    ^super begin",
