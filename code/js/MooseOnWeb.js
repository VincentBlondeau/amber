...
smalltalk.MWActionList.comment="This widget get the possible actions on an entity.";
smalltalk.addMethod(
smalltalk.method({
...
args: ["aJSObject"],
source: "add: aJSObject\x0a\x09\x22anObjectCollection contains MWMooseEntity under JSON format\x22\x0a    self entities add: (MWMooseEntity new id: aJSObject id; type: aJSObject type; name: aJSObject name).",
...
args: ["html"],
source: "renderContentOn: html\x0a    (self entities sorted: [:a :b | a name < b name ] ) do: [ :e |\x0a      html li \x0a    \x09  with:\x0a    \x09\x09  (html a\x0a   \x09\x09\x09\x09   href: '#';\x0a   \x09\x09\x09\x09   onClick: [ e clickFrom:  ((ul asJQuery parents: 'div') attr: 'row') ]; \x0a   \x09\x09\x09\x09   with: e name\x0a     \x09\x09\x09 )\x0a    ]",
...
args: ["html"],
source: "renderOn: html\x0a\x09ul := \x0a        html pre\x0a           class: 'pre-scrollable';\x0a           with: (\x0a    \x09\x09\x09html ul\x0a    \x09\x09\x09class: 'unstyled';\x0a        \x09\x09with: [self renderContentOn: html]\x0a              )",
